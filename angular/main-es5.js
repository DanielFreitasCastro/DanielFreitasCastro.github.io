...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngAfterViewInit = function () {
        ...
        setTimeout(function () {
            _this.term = "teste";
            setTimeout(function () {
                var elem = _this.button.nativeElement;
                elem.click();
            }, 2000);
        }, 2000);
    };
    HomeComponent.prototype.onFormSubmit = function (form) {
        if (!this.term.length) {
...
var ListComponent = /** @class */ (function () {
    function ListComponent(route, router, githubService) {
        this.route = route;
        this.router = router;
    ...
    ListComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.term = params.get("term");
            _this.githubService.getList(_this.term).subscribe(function (data) {
                if (!_this.term || !_this.term.length) {
                    _this.router.navigate(['/']);
                    return;
                }
                _this.list = data.items;
            }, function () { alert("Algo deu errado!"); });
        });
    };
...
var GithubService = /** @class */ (function () {
    ...
    GithubService.prototype.getList = function (term) {
